...
import br.com.alexsdm.postech.oficina.module.ordemServico.core.port.out.OrdemServicoClientePort;
import br.com.alexsdm.postech.oficina.module.ordemServico.core.port.out.OrdemServicoRepository;
import br.com.alexsdm.postech.oficina.module.ordemServico.core.port.in.BuscarOrdemServicoPorIdUseCase;
import br.com.alexsdm.postech.oficina.module.ordemServico.core.domain.exception.OrdemServicoClienteNaoEncontradoException;
import br.com.alexsdm.postech.oficina.module.ordemServico.core.domain.exception.OrdemServicoNaoEncontradaException;
import br.com.alexsdm.postech.oficina.module.ordemServico.core.domain.exception.OrdemServicoVeiculoNaoEncontradoException;
import br.com.alexsdm.postech.oficina.module.ordemServico.core.usecase.output.*;
...
public class BuscarOrdemServicoPorIdUseCaseImpl implements BuscarOrdemServicoPorIdUseCase {
    ...
    public BuscarOrdemServicoOutput executar(UUID id) {
        ...
        var cliente = ordemServicoClientePort.buscarCliente(ordemServico.getClienteId()).
