package br.com.alexsdm.postech.oficina.module.ordem_servico.core.domain.entity;
...
public class OrdemServico {
    ...
    public static OrdemServico criarOrdemServicoParaDiagnostico(UUID clienteId,
                                                                UUID veiculoId) {
    ...
    public static OrdemServico criarOrdemServicoParaExecucao(UUID clienteId,
                                                             UUID veiculoId,
                                                             List<ItemPecaOrdemServico> itensPecaOrdemServico,
                                                             List<ItemServicoOrdemServico> servicos
    ) {
