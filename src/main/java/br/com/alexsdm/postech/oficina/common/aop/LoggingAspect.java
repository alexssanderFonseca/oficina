package br.com.alexsdm.postech.oficina.common.aop;
...
public class LoggingAspect {
    ...
    @Around("execution(* br.com.alexsdm.postech.oficina..core.usecase.impl.*.*(..))")
    public Object logUseCase(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        logger.info("Execução Use Case: {}.{}() | Args: {}", className, methodName, Arrays.toString(args));

        Object result = joinPoint.proceed();
        long elapsedTime = System.currentTimeMillis() - startTime;

        logger.info("Resultado Use Case: {}.{}() | Tempo de Execução: {}ms | Resultado: {}",
                className, methodName, elapsedTime, result);
