package br.com.alexsdm.postech.oficina.module.orcamento.adapter.out.persistence.mapper;

import br.com.alexsdm.postech.oficina.module.orcamento.core.entity.ItemPecaOrcamento;
import br.com.alexsdm.postech.oficina.module.orcamento.core.entity.Orcamento;
import br.com.alexsdm.postech.oficina.module.orcamento.core.entity.ItemServicoOrcamento;
import br.com.alexsdm.postech.oficina.module.orcamento.core.entity.OrcamentoStatus;
import br.com.alexsdm.postech.oficina.module.orcamento.adapter.out.persistence.entity.ItemPecaOrcamentoEntity;
import br.com.alexsdm.postech.oficina.module.orcamento.adapter.out.persistence.entity.OrcamentoEntity;
import br.com.alexsdm.postech.oficina.module.orcamento.adapter.out.persistence.entity.ItemServicoOrcamentoEntity;
import br.com.alexsdm.postech.oficina.module.orcamento.adapter.out.persistence.entity.OrcamentoStatusEntity;
...
public class OrcamentoMapper {
    ...
    public OrcamentoEntity toEntity(Orcamento domain) {
        ...
        entity.setItensPeca(domain.getItensPeca().stream().map((item) ->
                this.toEntity(item, entity)).collect(Collectors.toList()));
        return entity;
    }
