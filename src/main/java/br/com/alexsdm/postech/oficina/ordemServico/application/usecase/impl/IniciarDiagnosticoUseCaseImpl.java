...
import br.com.alexsdm.postech.oficina.ordemServico.application.usecase.IniciarDiagnosticoUseCase;
...
public class IniciarDiagnosticoUseCaseImpl implements IniciarDiagnosticoUseCase {
    ...
    @Override public void executar(Long id) { var os = buscarUseCase.executar(id); /* TODO: Lógica de negócio */ gateway.salvar(os); }
}